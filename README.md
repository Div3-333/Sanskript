...
Current grammar infrastructure includes phonology, transliteration, first-pass sandhi modules, and a strict real-handler truth gate for sutras. The canon currently marks 93 sutras as `implemented`; the old generated 3174 count has been rejected because metadata profiles are not the same as discrete Paninian executable logic.
