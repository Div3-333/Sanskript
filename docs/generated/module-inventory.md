...
_Generated at 2026-05-27T12:44:21+00:00 by `tools/generate_module_inventory.py`._

**212** modules (207 Python, 5 Rust). Average replaceability score: **28.2** / 100.
...
| `src/sanskript/ast.py` | python | compiler | M11 | port_directly | 45 | 1155 |
| `src/sanskript/avyaya.py` | python | grammar_engine | M11 | redesign | 12 | 117 |
| `src/sanskript/bytecode.py` | python | vm | M9 | port_directly | 50 | 941 |
...
| `src/sanskript/cli.py` | python | other | M19 | port_directly | 30 | 203 |
| `src/sanskript/comments.py` | python | other | M19 | port_directly | 30 | 73 |
| `src/sanskript/compiler.py` | python | compiler | M11 | port_directly | 45 | 2843 |
| `src/sanskript/derivation.py` | python | grammar_engine | M11 | redesign | 12 | 295 |
| `src/sanskript/errors.py` | python | runtime | M3 | port_directly | 65 | 86 |
...
| `src/sanskript/morphology_facade.py` | python | grammar_engine | M11 | redesign | 12 | 236 |
| `src/sanskript/morphology_lexicon.py` | python | grammar_engine | M11 | redesign | 12 | 263 |
| `src/sanskript/morphology_synth.py` | python | grammar_engine | M11 | redesign | 12 | 870 |
| `src/sanskript/morphology_text.py` | python | grammar_engine | M11 | redesign | 12 | 36 |
| `src/sanskript/morphology_validate.py` | python | grammar_engine | M11 | redesign | 12 | 85 |
| `src/sanskript/oop.py` | python | other | M19 | port_directly | 30 | 254 |
| `src/sanskript/package_lock.py` | python | other | M19 | port_directly | 30 | 152 |
| `src/sanskript/package_manifest.py` | python | other | M19 | port_directly | 30 | 264 |
| `src/sanskript/package_resolver.py` | python | other | M19 | port_directly | 30 | 289 |
| `src/sanskript/package_signing.py` | python | other | M19 | port_directly | 30 | 78 |
...
| `src/sanskript/parser.py` | python | compiler | M11 | port_directly | 45 | 2711 |
| `src/sanskript/parser_core.py` | python | other | M19 | port_directly | 30 | 463 |
| `src/sanskript/performance.py` | python | other | M19 | port_directly | 30 | 83 |
...
| `src/sanskript/phase3_values.py` | python | other | M19 | port_directly | 30 | 248 |
| `src/sanskript/phase8_functional.py` | python | other | M19 | port_directly | 30 | 350 |
...
| `src/sanskript/sandhi.py` | python | grammar_engine | M11 | redesign | 12 | 146 |
| `src/sanskript/scope.py` | python | other | M19 | port_directly | 30 | 59 |
| `src/sanskript/script_normalize.py` | python | other | M19 | port_directly | 30 | 387 |
| `src/sanskript/source_context.py` | python | other | M19 | port_directly | 30 | 44 |
| `src/sanskript/source_pipeline.py` | python | other | M19 | port_directly | 30 | 99 |
| `src/sanskript/stdlib_common.py` | python | other | M19 | port_directly | 30 | 127 |
| `src/sanskript/stdlib_core.py` | python | other | M19 | port_directly | 30 | 42 |
| `src/sanskript/stdlib_impl.py` | python | other | M19 | port_directly | 30 | 1304 |
...
| `src/sanskript/sutra_logic.py` | python | grammar_engine | M11 | redesign | 12 | 1697 |
...
| `src/sanskript/type_checker.py` | python | other | M19 | port_directly | 30 | 1100 |
| `src/sanskript/vm.py` | python | vm | M9 | port_directly | 50 | 1376 |
...
| `src/sanskript/yantra_patha.py` | python | vm | M9 | port_directly | 50 | 759 |
...
| `tests/test_cli_toolchain.py` | python | tests | M15 | keep_temporarily | 25 | 72 |
...
| `tests/test_native_levels.py` | python | tests | M15 | keep_temporarily | 25 | 62 |
...
| `tests/test_phase10_stdlib_core.py` | python | tests | M15 | keep_temporarily | 25 | 360 |
| `tests/test_phase1_source_surface.py` | python | tests | M15 | keep_temporarily | 25 | 167 |
| `tests/test_phase2_core_syntax.py` | python | tests | M15 | keep_temporarily | 25 | 288 |
| `tests/test_phase3_data_types.py` | python | tests | M15 | keep_temporarily | 25 | 1303 |
| `tests/test_phase4_type_system.py` | python | tests | M15 | keep_temporarily | 25 | 662 |
| `tests/test_phase5_control_flow.py` | python | tests | M15 | keep_temporarily | 25 | 744 |
| `tests/test_phase6_functions.py` | python | tests | M15 | keep_temporarily | 25 | 445 |
| `tests/test_phase7_oop.py` | python | tests | M15 | keep_temporarily | 25 | 345 |
| `tests/test_phase8_functional_declarative.py` | python | tests | M15 | keep_temporarily | 25 | 323 |
| `tests/test_phase9_modules.py` | python | tests | M15 | keep_temporarily | 25 | 439 |
| `tests/test_phase_examples.py` | python | tests | M15 | keep_temporarily | 25 | 57 |
...
| `tests/test_sandhi.py` | python | tests | M15 | keep_temporarily | 25 | 39 |
...
| `tests/test_transliteration.py` | python | tests | M15 | keep_temporarily | 25 | 40 |
| `tests/test_type_catalog.py` | python | tests | M15 | keep_temporarily | 25 | 64 |
| `tests/test_vm_numeric_heap.py` | python | tests | M15 | keep_temporarily | 25 | 70 |
...
| `tools/generate_module_inventory.py` | python | tooling | M15 | keep_temporarily | 55 | 136 |
