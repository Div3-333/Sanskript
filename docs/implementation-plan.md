...
- The current real-handler gate contributes 230 implemented sutras. The previous generated Adhyaya 1-6 metric is explicitly rejected.
...
- 230 sutras have real-handler executable implementations; the rest remain partial or batch-partial.
