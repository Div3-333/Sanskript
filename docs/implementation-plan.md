...
- The current real-handler gate contributes 3983 implemented sutras. The previous generated Adhyaya 1-6 metric is explicitly rejected.
...
- 3983 sutras have real-handler executable implementations; the rest remain partial or batch-partial.
