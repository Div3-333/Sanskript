...
- The current real-handler gate contributes 1060 implemented sutras. The previous generated Adhyaya 1-6 metric is explicitly rejected.
...
- 1060 sutras have real-handler executable implementations; the rest remain partial or batch-partial.
