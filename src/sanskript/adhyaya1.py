...
DISCRETE_SUTRA_EVIDENCE: dict[str, dict[str, object]] = {
    ...
    "1.4.3": {
        "sutra_text_devanagari": "यू स्त्र्याख्यौ नदी",
        "sutra_text_iast": "yū stryākhyau nadī",
        "source": PANINI_SOURCE,
        "anuvritti": ("saṃjñā domain",),
        "conditions": ("Feminine ī/ū stems receive nadī-saṃjñā.",),
        "exceptions": ("Non-feminine stems do not receive nadī-saṃjñā by this rule.",),
        "counterexamples": _example("hari", "not nadī", "The feminine ī/ū condition is absent."),
        "reviewer_notes": ("Behavior is executable through categories.assign_technical_names.",),
    },
    "1.4.7": {
        "sutra_text_devanagari": "शेषो घ्यसखि",
        "sutra_text_iast": "śeṣo ghyasakhi",
        "source": PANINI_SOURCE,
        "anuvritti": ("saṃjñā domain",),
        "conditions": ("Remaining i/u-final stems except sakhi receive ghi-saṃjñā.",),
        "exceptions": ("sakhi is excluded.",),
        "counterexamples": _example("sakhi", "not ghi", "The explicit sakhi exception applies."),
        "reviewer_notes": ("Behavior is executable through categories.assign_technical_names.",),
    },
    "1.4.10": {
        "sutra_text_devanagari": "ह्रस्वं लघु",
        "sutra_text_iast": "hrasvaṃ laghu",
        "source": PANINI_SOURCE,
        "anuvritti": ("prosodic saṃjñā domain",),
        "conditions": ("A short vowel is laghu unless made guru by a later condition.",),
        "exceptions": ("A following consonant cluster or long vowel blocks laghu.",),
        "counterexamples": _example("ārambha", "guru", "The vowel is long, not hrasva."),
        "reviewer_notes": ("Behavior is executable through categories.get_vowel_weight.",),
    },
    "1.4.11": {
        "sutra_text_devanagari": "संयोगे गुरु",
        "sutra_text_iast": "saṃyoge guru",
        "source": PANINI_SOURCE,
        "anuvritti": ("prosodic saṃjñā domain",),
        "conditions": ("A vowel followed by a consonant cluster is guru.",),
        "exceptions": ("A vowel not followed by a cluster falls back to length.",),
        "counterexamples": _example("pa", "laghu", "No following saṃyoga is present."),
        "reviewer_notes": ("Behavior is executable through categories.get_vowel_weight.",),
    },
    "1.4.12": {
        "sutra_text_devanagari": "दीर्घं च",
        "sutra_text_iast": "dīrghaṃ ca",
        "source": PANINI_SOURCE,
        "anuvritti": ("prosodic saṃjñā domain",),
        "conditions": ("A long vowel or diphthong is guru.",),
        "exceptions": ("A short open vowel remains laghu absent another guru condition.",),
        "counterexamples": _example("pa", "laghu", "The vowel is short and open."),
        "reviewer_notes": ("Behavior is executable through categories.get_vowel_weight.",),
    },
    "1.4.13": {
        "sutra_text_devanagari": "यस्मात्प्रत्ययविधिस्तदादि प्रत्ययेऽङ्गम्",
        "sutra_text_iast": "yasmāt pratyayavidhis tadādi pratyaye'ṅgam",
        "source": PANINI_SOURCE,
        "anuvritti": ("aṅga-saṃjñā domain",),
        "conditions": ("A base before a suffix receives aṅga-saṃjñā.",),
        "exceptions": ("Without a suffix environment, this aṅga assignment is absent.",),
        "counterexamples": _example("deva without suffix", "not aṅga by 1.4.13", "No pratyaya condition is present."),
        "reviewer_notes": ("Behavior is executable through categories.assign_technical_names suffix_surface handling.",),
    },
    "1.4.14": {
        "sutra_text_devanagari": "सुप्तिङन्तं पदम्",
        "sutra_text_iast": "suptiṅantaṃ padam",
        "source": PANINI_SOURCE,
        "anuvritti": ("pada-saṃjñā domain",),
        "conditions": ("A sup- or tiṅ-ending form receives pada-saṃjñā.",),
        "exceptions": ("A bare nominal without case/finite ending is not a pada by this rule.",),
        "counterexamples": _example("bare deva", "not pada", "No sup or tiṅ ending is represented."),
        "reviewer_notes": ("Behavior is executable through categories.assign_technical_names and categories.is_pada.",),
    },
    "1.4.18": {
        "sutra_text_devanagari": "यचि भम्",
        "sutra_text_iast": "yaci bham",
        "source": PANINI_SOURCE,
        "anuvritti": ("bha-saṃjñā domain",),
        "conditions": ("A pada before y or vowel-initial suffixes receives bha-saṃjñā.",),
        "exceptions": ("Consonant-initial non-y suffixes keep the ordinary pada path.",),
        "counterexamples": _example("deva + ta", "not bha", "The suffix does not begin with y or ac."),
        "reviewer_notes": ("Behavior is executable through categories.assign_technical_names suffix_surface handling.",),
    },
    "1.4.24": {
        "sutra_text_devanagari": "ध्रुवमपायेऽपादानम्",
        "sutra_text_iast": "dhruvam apāye'pādānam",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The fixed point in separation receives apādāna.",),
        "exceptions": ("A non-separation context does not receive apādāna by this rule.",),
        "counterexamples": _example("ordinary location", "not apādāna", "The apāya condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role separation_point.",),
    },
    "1.4.25": {
        "sutra_text_devanagari": "भीत्रार्थानां भयहेतुः",
        "sutra_text_iast": "bhītrārthānāṃ bhayahetuḥ",
        "source": PANINI_SOURCE,
        "anuvritti": ("apādāna from 1.4.24",),
        "conditions": ("For bhī/trā meanings, the cause of fear receives apādāna.",),
        "exceptions": ("Other verbal roots do not use this fear-cause rule.",),
        "counterexamples": _example("ruc + cause_of_fear", "not apādāna", "The root condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role root/context matching.",),
    },
    "1.4.26": {
        "sutra_text_devanagari": "पराजेरसोढः",
        "sutra_text_iast": "parājer asoḍhaḥ",
        "source": PANINI_SOURCE,
        "anuvritti": ("apādāna from 1.4.24",),
        "conditions": ("The unbearable object in the parā-ji domain receives apādāna.",),
        "exceptions": ("The same context without parā-ji is not licensed by this rule.",),
        "counterexamples": _example("ji + unbearable", "not apādāna by 1.4.26", "The prefixed root condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role parā-ji/unbearable matching.",),
    },
    "1.4.27": {
        "sutra_text_devanagari": "वारणार्थानामीप्सितः",
        "sutra_text_iast": "vāraṇārthānām īpsitaḥ",
        "source": PANINI_SOURCE,
        "anuvritti": ("apādāna from 1.4.24",),
        "conditions": ("The object warded off in prevention meanings receives apādāna.",),
        "exceptions": ("A non-prevention object is not licensed by this rule.",),
        "counterexamples": _example("ordinary desired object", "not apādāna", "The vāraṇa condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role warded_off_object.",),
    },
    "1.4.28": {
        "sutra_text_devanagari": "अन्तर्धौ येनादर्शनमिच्छति",
        "sutra_text_iast": "antardhau yenādarśanam icchati",
        "source": PANINI_SOURCE,
        "anuvritti": ("apādāna from 1.4.24",),
        "conditions": ("That from which one wishes concealment receives apādāna.",),
        "exceptions": ("A visible/ordinary object lacks this antardhā condition.",),
        "counterexamples": _example("ordinary object", "not apādāna", "No hiding-from relation is present."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role hidden_from.",),
    },
    "1.4.29": {
        "sutra_text_devanagari": "आख्यातोपयोगे",
        "sutra_text_iast": "ākhyātopayoge",
        "source": PANINI_SOURCE,
        "anuvritti": ("apādāna from 1.4.24",),
        "conditions": ("The source/teacher in learning or recitation receives apādāna.",),
        "exceptions": ("Non-source participants are not licensed by this rule.",),
        "counterexamples": _example("student", "not apādāna", "The source/teacher role is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role teacher.",),
    },
    "1.4.32": {
        "sutra_text_devanagari": "कर्मणा यमभिप्रैति स सम्प्रदानम्",
        "sutra_text_iast": "karmaṇā yam abhipraiti sa sampradānam",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The intended recipient of an action receives sampradāna.",),
        "exceptions": ("A non-recipient participant is not sampradāna by this rule.",),
        "counterexamples": _example("instrument", "not sampradāna", "The intended-recipient condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role intended_recipient.",),
    },
    "1.4.33": {
        "sutra_text_devanagari": "रुच्यर्थानां प्रीयमाणः",
        "sutra_text_iast": "rucyarthānāṃ prīyamāṇaḥ",
        "source": PANINI_SOURCE,
        "anuvritti": ("sampradāna from 1.4.32",),
        "conditions": ("For ruc meanings, the one pleased receives sampradāna.",),
        "exceptions": ("Other roots do not use this pleased-one rule.",),
        "counterexamples": _example("bhū + pleased_one", "not sampradāna", "The ruc root condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role ruc/pleased_one matching.",),
    },
    "1.4.42": {
        "sutra_text_devanagari": "साधकतमं करणम्",
        "sutra_text_iast": "sādhakatamaṃ karaṇam",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The most effective means receives karaṇa.",),
        "exceptions": ("A participant not functioning as means is not karaṇa by this rule.",),
        "counterexamples": _example("recipient", "not karaṇa", "The means condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role most_effective_means.",),
    },
    "1.4.45": {
        "sutra_text_devanagari": "आधारोऽधिकरणम्",
        "sutra_text_iast": "ādhāro'dhikaraṇam",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The substratum/location receives adhikaraṇa.",),
        "exceptions": ("A non-locus participant is not adhikaraṇa by this rule.",),
        "counterexamples": _example("agent", "not adhikaraṇa", "The substratum condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role substratum.",),
    },
    "1.4.49": {
        "sutra_text_devanagari": "कर्तुरीप्सिततमं कर्म",
        "sutra_text_iast": "kartur īpsitatamaṃ karma",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The object most desired by the agent receives karman.",),
        "exceptions": ("An undesired or unrelated participant is not karman by this rule.",),
        "counterexamples": _example("instrument", "not karman", "The īpsitatama condition is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role most_desired/ipsitatama.",),
    },
    "1.4.54": {
        "sutra_text_devanagari": "स्वतन्त्रः कर्ता",
        "sutra_text_iast": "svatantraḥ kartā",
        "source": PANINI_SOURCE,
        "anuvritti": ("kāraka domain",),
        "conditions": ("The independent participant in the action receives kartṛ.",),
        "exceptions": ("A dependent instrument or object is not kartṛ by this rule.",),
        "counterexamples": _example("instrument", "not kartṛ", "Independence is absent."),
        "reviewer_notes": ("Behavior is executable through karaka.get_karaka_role independent_agent.",),
    },
    "1.4.109": {
        "sutra_text_devanagari": "परः सन्निकर्षः संहिता",
        "sutra_text_iast": "paraḥ sannikarṣaḥ saṃhitā",
        "source": PANINI_SOURCE,
        "anuvritti": ("sound-boundary domain",),
        "conditions": ("Close phonological proximity is saṃhitā.",),
        "exceptions": ("No sound sequence means no saṃhitā relation.",),
        "counterexamples": _example("", "not saṃhitā", "No adjacent sound material is present."),
        "reviewer_notes": ("Behavior is executable through categories.is_samhita.",),
    },
    "1.4.110": {
        "sutra_text_devanagari": "विरामोऽवसानम्",
        "sutra_text_iast": "virāmo'vasānam",
        "source": PANINI_SOURCE,
        "anuvritti": ("sound-boundary domain",),
        "conditions": ("Cessation at or beyond the end of the sound stream is avasāna.",),
        "exceptions": ("A position before the end is not avasāna.",),
        "counterexamples": _example("bhavati at index 1", "not avasāna", "Sound continues after the index."),
        "reviewer_notes": ("Behavior is executable through categories.is_avasana.",),
    },
}
