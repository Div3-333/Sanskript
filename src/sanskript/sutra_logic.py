...
def _build_registry() -> dict[str, DiscreteSutraLogic]:
    ...
    _add(registry, "1.2.1", SutraOperator.SAMJNA, "marks suffixes after gang/kutadi roots as ngit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("ta", markers=frozenset(c.get("markers", ())))).get_is_ngit(), _ctx("1.2.1", root="gāṅ", markers=()), _ctx("1.2.1", root="gāṅ", markers=("ñ",)), "samjna:ngit")
    _add(registry, "1.2.2", SutraOperator.SAMJNA, "marks it augment after vij as ngit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("ta"), is_it_augment=bool(c.get("it"))).get_is_ngit(), _ctx("1.2.2", root="vij", it=True), _ctx("1.2.2", root="vij", it=False), "samjna:ngit")
    _add(registry, "1.2.4", SutraOperator.SAMJNA, "marks apit sarvadhatuka suffixes as ngit", lambda c: DerivationContext(suffix=Suffix("ti", markers=frozenset(c.get("markers", ())), is_sarvadhatuka=True)).get_is_ngit(), _ctx("1.2.4", markers=()), _ctx("1.2.4", markers=("p",)), "samjna:ngit")
    _add(registry, "1.2.5", SutraOperator.SAMJNA, "marks lit after non-cluster roots as kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("liṭ", is_lit=True)).get_is_kit(), _ctx("1.2.5", root="bhū"), _ctx("1.2.5", root="krt"), "samjna:kit")
    _add(registry, "1.2.6", SutraOperator.SAMJNA, "marks lit after indh/bhu as kit", lambda c: str(c.get("root")) in {"indh", "bhū"} and DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("liṭ", is_lit=True)).get_is_kit(), _ctx("1.2.6", root="indh"), _ctx("1.2.6", root="pac"), "samjna:kit")
    _add(registry, "1.2.7", SutraOperator.SAMJNA, "marks ktva after listed roots as kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("ktvā", is_ktva=True)).get_is_kit(), _ctx("1.2.7", root="mṛḍ"), _ctx("1.2.7", root="bhū"), "samjna:kit")
    _add(registry, "1.2.8", SutraOperator.SAMJNA, "marks ktva/san with it augment after listed roots as kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("san", is_san=True), is_it_augment=bool(c.get("it"))).get_is_kit(), _ctx("1.2.8", root="rud", it=True), _ctx("1.2.8", root="rud", it=False), "samjna:kit")
    _add(registry, "1.2.9", SutraOperator.SAMJNA, "marks san after ik-final roots before jhal as kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("sa", is_san=True)).get_is_kit(), _ctx("1.2.9", root="ci"), _ctx("1.2.9", root="gam"), "samjna:kit")
    _add(registry, "1.2.11", SutraOperator.SAMJNA, "marks lin/sic in atmanepada as kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("sic", is_sic=True, is_atmanepada=bool(c.get("atmanepada")))).get_is_kit(), _ctx("1.2.11", root="pac", atmanepada=True), _ctx("1.2.11", root="pac", atmanepada=False), "samjna:kit")
    _add(registry, "1.2.12", SutraOperator.SAMJNA, "marks sic after short r-final roots as kit", lambda c: str(c.get("root")).endswith("ṛ") and DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("sic", is_sic=True, is_atmanepada=True)).get_is_kit(), _ctx("1.2.12", root="kṛ"), _ctx("1.2.12", root="pac"), "samjna:kit")
    for sutra_id, root in (("1.2.13", "gam"), ("1.2.14", "han"), ("1.2.15", "yam"), ("1.2.17", "sthā")):
        _add(registry, sutra_id, SutraOperator.SAMJNA, f"marks sic after {root} as kit in the controlled context", lambda c, expected=root: str(c.get("root")) == expected and DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("sic", is_sic=True, is_atmanepada=True)).get_is_kit(), _ctx(sutra_id, root=root), _ctx(sutra_id, root="pac"), "samjna:kit")
    _add(registry, "1.2.18", SutraOperator.PRATISEDHA, "blocks kit status for set ktva", lambda c: not DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("ktvā", is_ktva=True), is_it_augment=bool(c.get("it"))).get_is_kit(), _ctx("1.2.18", root="bhū", it=True), _ctx("1.2.18", root="mṛḍ", it=False), "block:kit")
    for sutra_id, root in (("1.2.19", "śīṅ"), ("1.2.20", "mṛṣ")):
        _add(registry, sutra_id, SutraOperator.PRATISEDHA, f"blocks kit status for nistha after {root}", lambda c, expected=root: str(c.get("root")) == expected and not DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("kta", is_nistha=True), is_it_augment=True).get_is_kit(), _ctx(sutra_id, root=root), _ctx(sutra_id, root="bhū"), "block:kit")
    _add(registry, "1.2.26", SutraOperator.VIBHASHA, "marks san/ktva with it augment after controlled ral roots as optionally kit", lambda c: DerivationContext(root_lemma=str(c.get("root")), suffix=Suffix("san", is_san=True), is_it_augment=True).get_is_kit(), _ctx("1.2.26", root="kic"), _ctx("1.2.26", root="gam"), "samjna:kit")
    _add(registry, "1.2.41", SutraOperator.SAMJNA, "assigns aprkta to single-sound suffixes", lambda c: is_aprkta(c.get("analysis")), _ctx("1.2.41", analysis=Analysis("s", "s", PartOfSpeech.INDECLINABLE)), _ctx("1.2.41", analysis=Analysis("tas", "tas", PartOfSpeech.INDECLINABLE)), "samjna:aprkta")
    _add(registry, "1.2.64", SutraOperator.VIDHI, "uses one remainder for homonymous forms", lambda c: len({a.surface for a in c.get("analyses", ())}) == 1 and apply_ekashesha(list(c.get("analyses", ()))).lemma == c.get("lemma"), _ctx("1.2.64", analyses=(Analysis("go", "go", PartOfSpeech.NOUN), Analysis("go", "go", PartOfSpeech.NOUN)), lemma="go"), _ctx("1.2.64", analyses=(Analysis("go", "go", PartOfSpeech.NOUN), Analysis("aja", "aja", PartOfSpeech.NOUN)), lemma="go"), "operation:ekashesha")
    _add(registry, "1.2.65", SutraOperator.VIDHI, "keeps the elder term over the younger term", lambda c: apply_ekashesha(list(c.get("analyses", ()))).lemma == "arya", _ctx("1.2.65", analyses=(Analysis("arya", "arya", PartOfSpeech.NOUN), Analysis("aryayaṇa", "aryayaṇa", PartOfSpeech.NOUN))), _ctx("1.2.65", analyses=(Analysis("putra", "putra", PartOfSpeech.NOUN), Analysis("duhitṛ", "duhitṛ", PartOfSpeech.NOUN))), "operation:ekashesha")
    _add(registry, "1.2.67", SutraOperator.VIDHI, "keeps masculine over feminine in ekashesha", lambda c: apply_ekashesha(list(c.get("analyses", ()))).gender == Gender.MASCULINE, _ctx("1.2.67", analyses=(_analysis("rāma", "rāma", PartOfSpeech.NOUN, gender=Gender.MASCULINE), _analysis("sītā", "sītā", PartOfSpeech.NOUN, gender=Gender.FEMININE))), _ctx("1.2.67", analyses=(_analysis("sītā", "sītā", PartOfSpeech.NOUN, gender=Gender.FEMININE), _analysis("latā", "latā", PartOfSpeech.NOUN, gender=Gender.FEMININE))), "operation:ekashesha")
    _add(registry, "1.2.68", SutraOperator.VIDHI, "keeps bhratr/putra over paired kin terms", lambda c: apply_ekashesha(list(c.get("analyses", ()))).lemma == c.get("lemma"), _ctx("1.2.68", analyses=(Analysis("bhrātṛ", "bhrātṛ", PartOfSpeech.NOUN), Analysis("svasṛ", "svasṛ", PartOfSpeech.NOUN)), lemma="bhrātṛ"), _ctx("1.2.68", analyses=(Analysis("pitṛ", "pitṛ", PartOfSpeech.NOUN), Analysis("mātṛ", "mātṛ", PartOfSpeech.NOUN)), lemma="bhrātṛ"), "operation:ekashesha")
    _add(registry, "1.2.69", SutraOperator.VIDHI, "keeps neuter over non-neuter in ekashesha", lambda c: apply_ekashesha(list(c.get("analyses", ()))).gender == Gender.NEUTER, _ctx("1.2.69", analyses=(_analysis("phala", "phala", PartOfSpeech.NOUN, gender=Gender.NEUTER), _analysis("rāma", "rāma", PartOfSpeech.NOUN, gender=Gender.MASCULINE))), _ctx("1.2.69", analyses=(_analysis("rāma", "rāma", PartOfSpeech.NOUN, gender=Gender.MASCULINE), _analysis("sītā", "sītā", PartOfSpeech.NOUN, gender=Gender.FEMININE))), "operation:ekashesha")
    _add(registry, "1.2.70", SutraOperator.VIDHI, "keeps pitr over matr in ekashesha", lambda c: apply_ekashesha(list(c.get("analyses", ()))).lemma == "pitṛ", _ctx("1.2.70", analyses=(Analysis("pitṛ", "pitṛ", PartOfSpeech.NOUN), Analysis("mātṛ", "mātṛ", PartOfSpeech.NOUN))), _ctx("1.2.70", analyses=(Analysis("putra", "putra", PartOfSpeech.NOUN), Analysis("duhitṛ", "duhitṛ", PartOfSpeech.NOUN))), "operation:ekashesha")
    _add(registry, "1.2.71", SutraOperator.VIDHI, "keeps shvashura over shvashru in ekashesha", lambda c: apply_ekashesha(list(c.get("analyses", ()))).lemma == "śvaśura", _ctx("1.2.71", analyses=(Analysis("śvaśura", "śvaśura", PartOfSpeech.NOUN), Analysis("śvaśrū", "śvaśrū", PartOfSpeech.NOUN))), _ctx("1.2.71", analyses=(Analysis("pitṛ", "pitṛ", PartOfSpeech.NOUN), Analysis("mātṛ", "mātṛ", PartOfSpeech.NOUN))), "operation:ekashesha")
    _add(registry, "1.2.72", SutraOperator.VIDHI, "keeps tyadadi pronouns in ekashesha", lambda c: apply_ekashesha(list(c.get("analyses", ()))).lemma == "tad", _ctx("1.2.72", analyses=(Analysis("tad", "tad", PartOfSpeech.PRONOUN), Analysis("deva", "deva", PartOfSpeech.NOUN))), _ctx("1.2.72", analyses=(Analysis("deva", "deva", PartOfSpeech.NOUN), Analysis("rāma", "rāma", PartOfSpeech.NOUN))), "operation:ekashesha")
    _add(registry, "1.2.73", SutraOperator.VIDHI, "keeps feminine animal term in specified ekashesha domain", lambda c: apply_ekashesha(list(c.get("analyses", ()))).gender == Gender.FEMININE, _ctx("1.2.73", analyses=(_analysis("go", "go", PartOfSpeech.NOUN, gender=Gender.FEMININE), _analysis("aja", "aja", PartOfSpeech.NOUN, gender=Gender.MASCULINE))), _ctx("1.2.73", analyses=(_analysis("rāma", "rāma", PartOfSpeech.NOUN, gender=Gender.MASCULINE), _analysis("sītā", "sītā", PartOfSpeech.NOUN, gender=Gender.FEMININE))), "operation:ekashesha")
