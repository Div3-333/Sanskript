"""Patch schema-v2.json with Phase 3 opcodes."""
...
from sanskript.phase3_opcodes import all_phase3_opcode_names
...
def main() -> None:
    ...
    merged = sorted(set(existing) | set(all_phase3_opcode_names()))
